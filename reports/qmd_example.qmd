...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){width=70% #fig-horses}
...
![Horse sd figures](../results/horse_pops_plot_largest_sd.png){width=70% #fig-sd}
